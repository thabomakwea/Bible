...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allPsalms.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allPsalms.edges.length}
                            normalText={'Verses'}
                        />
...
query PsalmsChapters ($chapter: String) {
    allPsalms(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
