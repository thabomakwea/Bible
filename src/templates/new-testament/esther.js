...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allEsther.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allEsther.edges.length}
                            normalText={'Verses'}
                        />
...
query EstherChapters ($chapter: String) {
    allEsther(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
