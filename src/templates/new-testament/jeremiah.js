...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allJeremiah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allJeremiah.edges.length}
                            normalText={'Verses'}
                        />
...
query JeremiahChapters ($chapter: String) {
    allJeremiah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
