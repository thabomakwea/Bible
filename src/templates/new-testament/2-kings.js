...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoKings.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoKings.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoKingsChapters ($chapter: String) {
    allTwoKings(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
