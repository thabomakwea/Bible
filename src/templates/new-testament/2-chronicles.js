...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoChronicles.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoChronicles.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoChroniclesChapters ($chapter: String) {
    allTwoChronicles(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
