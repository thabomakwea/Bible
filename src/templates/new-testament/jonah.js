...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allJonah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allJonah.edges.length}
                            normalText={'Verses'}
                        />
...
query JonahChapters ($chapter: String) {
    allJonah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
