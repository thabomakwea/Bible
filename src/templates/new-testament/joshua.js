...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allJoshua.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allJoshua.edges.length}
                            normalText={'Verses'}
                        />
...
query JoshuaChapters ($chapter: String) {
    allJoshua(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
