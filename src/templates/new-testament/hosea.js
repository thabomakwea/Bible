...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allHosea.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allHosea.edges.length}
                            normalText={'Verses'}
                        />
...
query HoseaChapters ($chapter: String) {
    allHosea(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
