...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allLamentations.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allLamentations.edges.length}
                            normalText={'Verses'}
                        />
...
query LamentationsChapters ($chapter: String) {
    allLamentations(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
