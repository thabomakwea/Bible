...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allZechariah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allZechariah.edges.length}
                            normalText={'Verses'}
                        />
...
query ZechariahChapters ($chapter: String) {
    allZechariah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
