...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allIsaiah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allIsaiah.edges.length}
                            normalText={'Verses'}
                        />
...
query IsaiahChapters ($chapter: String) {
    allIsaiah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
