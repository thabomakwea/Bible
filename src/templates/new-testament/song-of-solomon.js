...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allSongOfSolomon.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allSongOfSolomon.edges.length}
                            normalText={'Verses'}
                        />
...
query SongOfSolomonChapters ($chapter: String) {
    allSongOfSolomon(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
