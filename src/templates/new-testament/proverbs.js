...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allProverbs.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allProverbs.edges.length}
                            normalText={'Verses'}
                        />
...
query ProverbsChapters ($chapter: String) {
    allProverbs(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
