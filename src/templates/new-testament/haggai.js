...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allHaggai.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allHaggai.edges.length}
                            normalText={'Verses'}
                        />
...
query HaggaiChapters ($chapter: String) {
    allHaggai(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
