...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allMalachi.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allMalachi.edges.length}
                            normalText={'Verses'}
                        />
...
query MalachiChapters ($chapter: String) {
    allMalachi(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
