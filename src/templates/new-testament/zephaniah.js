...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allZephaniah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allZephaniah.edges.length}
                            normalText={'Verses'}
                        />
...
query ZephaniahChapters ($chapter: String) {
    allZephaniah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
