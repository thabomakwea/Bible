...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allObadiah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allObadiah.edges.length}
                            normalText={'Verses'}
                        />
...
query ObadiahChapters ($chapter: String) {
    allObadiah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
