...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allEzekiel.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allEzekiel.edges.length}
                            normalText={'Verses'}
                        />
...
query EzekielChapters ($chapter: String) {
    allEzekiel(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
