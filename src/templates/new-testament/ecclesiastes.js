...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allEcclesiastes.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allEcclesiastes.edges.length}
                            normalText={'Verses'}
                        />
...
query EcclesiastesChapters ($chapter: String) {
    allEcclesiastes(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
