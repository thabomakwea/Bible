...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allOneChronicles.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allOneChronicles.edges.length}
                            normalText={'Verses'}
                        />
...
query OneChroniclesChapters ($chapter: String) {
    allOneChronicles(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
