...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allMicah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allMicah.edges.length}
                            normalText={'Verses'}
                        />
...
query MicahChapters ($chapter: String) {
    allMicah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
