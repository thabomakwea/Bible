...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allNehemiah.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allNehemiah.edges.length}
                            normalText={'Verses'}
                        />
...
query NehemiahChapters ($chapter: String) {
    allNehemiah(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
