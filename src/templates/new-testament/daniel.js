...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allDaniel.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allDaniel.edges.length}
                            normalText={'Verses'}
                        />
...
query DanielChapters ($chapter: String) {
    allDaniel(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
