...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allGalatians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allGalatians.edges.length}
                            normalText={'Verses'}
                        />
...
query GalatiansChapters ($chapter: String) {
    allGalatians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
