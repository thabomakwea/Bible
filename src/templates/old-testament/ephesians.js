...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allEphesians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allEphesians.edges.length}
                            normalText={'Verses'}
                        />
...
query EphesiansChapters ($chapter: String) {
    allEphesians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
