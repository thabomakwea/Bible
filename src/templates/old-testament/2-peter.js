...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoPeter.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoPeter.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoPeterChapters ($chapter: String) {
    allTwoPeter(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
