...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoThessalonians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-7">
                        ...
                        <Verse
                            verses={data.allTwoThessalonians}
                            selectedVerse={verse}
                        />
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoThessalonians.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoThessaloniansChapters ($chapter: String) {
    allTwoThessalonians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
