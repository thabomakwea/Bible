...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allHebrews.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allHebrews.edges.length}
                            normalText={'Verses'}
                        />
...
query HebrewsChapters ($chapter: String) {
    allHebrews(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
