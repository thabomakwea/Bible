...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allColossians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allColossians.edges.length}
                            normalText={'Verses'}
                        />
...
query ColossiansChapters ($chapter: String) {
    allColossians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
