...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoCorinthians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoCorinthians.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoCorinthiansChapters ($chapter: String) {
    allTwoCorinthians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
