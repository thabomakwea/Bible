...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTitus.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTitus.edges.length}
                            normalText={'Verses'}
                        />
...
query TitusChapters ($chapter: String) {
    allTitus(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
