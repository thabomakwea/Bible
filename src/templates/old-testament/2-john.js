...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoJohn.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoJohn.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoJohnChapters ($chapter: String) {
    allTwoJohn(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
