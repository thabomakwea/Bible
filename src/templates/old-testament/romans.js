...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allRomans.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allRomans.edges.length}
                            normalText={'Verses'}
                        />
...
query RomansChapters ($chapter: String) {
    allRomans(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
