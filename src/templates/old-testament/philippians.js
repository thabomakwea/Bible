...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allPhilippians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allPhilippians.edges.length}
                            normalText={'Verses'}
                        />
...
query PhilippiansChapters ($chapter: String) {
    allPhilippians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
