...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allMatthew.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allMatthew.edges.length}
                            normalText={'Verses'}
                        />
...
query MatthewChapters ($chapter: String) {
    allMatthew(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
