...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allPhilemon.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allPhilemon.edges.length}
                            normalText={'Verses'}
                        />
...
query PhilemonChapters ($chapter: String) {
    allPhilemon(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
