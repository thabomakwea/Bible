...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allRevelation.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allRevelation.edges.length}
                            normalText={'Verses'}
                        />
...
query RevelationChapters ($chapter: String) {
    allRevelation(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
