...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allOneJohn.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allOneJohn.edges.length}
                            normalText={'Verses'}
                        />
...
query OneJohnChapters ($chapter: String) {
    allOneJohn(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
