...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allOneCorinthians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allOneCorinthians.edges.length}
                            normalText={'Verses'}
                        />
...
query OneCorinthiansChapters ($chapter: String) {
    allOneCorinthians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
