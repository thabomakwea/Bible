...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allJames.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allJames.edges.length}
                            normalText={'Verses'}
                        />
...
query JamesChapters ($chapter: String) {
    allJames(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
