...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allOneTimothy.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allOneTimothy.edges.length}
                            normalText={'Verses'}
                        />
...
query OneTimothyChapters ($chapter: String) {
    allOneTimothy(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
