...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allTwoTimothy.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allTwoTimothy.edges.length}
                            normalText={'Verses'}
                        />
...
query TwoTimothyChapters ($chapter: String) {
    allTwoTimothy(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
