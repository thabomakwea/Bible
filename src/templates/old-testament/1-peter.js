...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allOnePeter.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allOnePeter.edges.length}
                            normalText={'Verses'}
                        />
...
query OnePeterChapters ($chapter: String) {
    allOnePeter(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
