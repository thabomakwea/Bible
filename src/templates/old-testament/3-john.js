...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allThreeJohn.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allThreeJohn.edges.length}
                            normalText={'Verses'}
                        />
...
query ThreeJohnChapters ($chapter: String) {
    allThreeJohn(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
