...
const ChapterDetails = ({ data, pageContext }) => {
    ...
    return (
        <Layout
            ...
            numbers={data.allOneThessalonians.edges.length}
            ...
            <div className="container chapter">
                ...
                <div className="row">
                    ...
                    <div className="col-7">
                        ...
                        <Verse
                            verses={data.allOneThessalonians}
                            selectedVerse={verse}
                        />
                    ...
                    <div className="col-4 offset-1">
                        ...
                        <ChapterHeader
                            darkText={data.allOneThessalonians.edges.length}
                            normalText={'Verses'}
                        />
...
query OneThessaloniansChapters ($chapter: String) {
    allOneThessalonians(filter: { chapter: { eq: $chapter } }) {
    edges {
      node {
                book
                bible
